...
public class Parqueadero {
    ...
    public void avanzarHora() {
        ...
        if (horaActual == 6  || horaActual == 7 || horaActual == 8 || horaActual == 9 || horaActual == 10
                || horaActual == 11 || horaActual == 12 || horaActual == 13 || horaActual == 14 || horaActual == 15
                || horaActual == 16 || horaActual == 17 || horaActual == 18 || horaActual == 19 ){horaActual++;}
        //horaActual++;
    }
    ...
    public boolean estaAbierto() {
        if (horaActual == 6  || horaActual == 7 || horaActual == 8 || horaActual == 9 || horaActual == 10
                || horaActual == 11 || horaActual == 12 || horaActual == 13 || horaActual == 14 || horaActual == 15
                || horaActual == 16 || horaActual == 17 || horaActual == 18 || horaActual == 19 )
        {return abierto;}
        return false;
    }
     ...
     * Retorna la placa del carro que lleva mas tiempo en el parqueadero
    ...
    public String metodo1() {
        ...
        for (Puesto p : puestos){
            if ( p.estaOcupado() && (p.darCarro().darHoraLlegada() > hora)) {
                placaCarro = p.darCarro().darPlaca();
                return placaCarro;
            }
        }
        return "Parqueadero Vacio";
    }
